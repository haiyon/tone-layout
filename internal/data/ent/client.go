...
func (c *GreeterClient) UpdateOneID(id string) *GreeterUpdateOne {
...
func (c *GreeterClient) DeleteOneID(id string) *GreeterDeleteOne {
...
func (c *GreeterClient) Get(ctx context.Context, id string) (*Greeter, error) {
	return c.Query().Where(greeter.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *GreeterClient) GetX(ctx context.Context, id string) *Greeter {
